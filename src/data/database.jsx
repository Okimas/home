    ...
    script: [
      {
        ...
        texts: [
          ...
          {
            text: `Podemos criar uma conexão ativa no LinkedIn!? <a href="https://br.linkedin.com/in/ricardo-okimoto" target="_blank">Envie um convite</a>.<br/><br/>`,
          },
          {
            title: "Mais que interesse profissional",
        ...
        texts: [
          {
            ...
            text: 'Sou formado em engenharia mecânica pela <a href="https://ufu.br" target="_blank">UFU (Universidade Federal de Uberlândia-MG)</a>. Durante dois anos fui aluno bolsista de IC (Iniciação Científica), desenvolvendo <i>softwares</i> nas linguagens <i>Turbo Pascal</i> e <i>Turbo C</i>, específicos à engenharia (simuladores térmicos). Este foi o meu início na programação.<br/>Tenho pós-graduação em Administração de Empresas pela <a href="https://www.faap.br" target="_blank">FAAP (Fundação Armando Álvares Penteado)</a> e MBA em Gestão de Projetos e Tecnologia pelo <a href="https://www.ipt.br" target="_blank">IPT (Instituto de Pesquisas Tecnológicas)</a>.',
          },
          {
            title: "Sem diploma, mas Mestre",
            text: 'Em média, faço três cursos ao mês. Na maioria, cursos em vídeo, como os da <a href="https://www.udemy.com" target="_blank">Udemy</a>.<br/>Temas recorrentes: Linguagens de Programação, <i>Frameworks</i>, Plataformas... Tecnologias, Agricultura, Física, História... Inglês*, Japonês...<br/>* <span style="font-size:smaller">Os melhores cursos estão na língua inglesa. Sou fluente? Não. Inglês, entendo quase tudo o que leio e escuto, mas não tenho prática na conversação.</span>',
          },
        ],
      },
      {
        ...
        texts: [
          {
            ...
            text: `I am a Mechanical Engineer from the <a href="https://ufu.br" target="_blank"><i>Universidade Federal de Uberlândia - MG.</i></a>. For two years I was a scholarship student developing software in the languages <i>Turbo Pascal</i> and <i>Turbo C</i> specific to engineering. Was my beginning in programming.<br/>I have a postgraduate degree in Business Management from <a href="https://www.faap.br" target="_blank"><i>FAAP (Fundação Armando Alvares Penteado)</i></a> and MAB in Projects and Technology Management from <a href="https://www.ipt.br" target="_blank"><i>IPT (Instituto de Pesquisas Tecnológicas)</i></a>.`,
          },
          {
            title: "no diploma",
            text: `On average, I take three courses a month. For the most part, video courses like those from <a href="https://www.udemy.com" target="_blank">Udemy</a><br/>Recurring themes are programming languages, frameworks, platforms... technologies, agriculture, physics, history... English*, Japanese...<br/>* <span style="font-size:smaller">The best courses are in English language but I'm not fluent. I just understand what is needed, but I'm not good at conversation.</span>`,
          },
        ],
      },
      {
        ...
        texts: [
          {
            ...
            text: `After graduation, I worked with central air conditioning (design and installation) at <a href="https://riberar.com.br" target="_blank">Riberar</a> in <i>Ribeirão Preto - SP</i>.<br>Less than a year later, I had an opportunity to work in a larger company, manufacturer of water and gas meters, <a href="http://laoindustria.com.br" target="_blank">LAO Indústria</a> which operated in an area that I already had some interest in, water supply and sanitation. Working in the company, shortly afterwards, the technology area that, until then, was focused only on meter projects, was renamed "Measurement Systems", developing electronics (centralized metering, data loggers and IoTs) and software. I developed from simple user/device's interfaces to platforms for analysis and management of data collected remotely in real time. I worked as an application engineer, managing projects and developing various software solutions for over 142 years.`,
          },
          {
            title: "self-employed",
            text: `Still an employee, thinking about having my own company, I studied and worked almost every night and at some point requests for projects in software and systems started to appear, more than I could handle, working in a company. At that time, any problem, of any kind, seemed to require a solution in software or a digital platform. I started as a self-employed worker in 2012. This high demand for solutions in software/platforms could not have different consequences. Many companies have entered on this market and an explosion of freelance developers. The competition had not significantly affected my business. I had several finished projects in use, a good network of contacts and my clients weren't the big one.`,
          },
          {
        ...
        texts: [
          {
            ...
            text: 'If you have any questions about me or my work or just have a job in the same field and want to keep in touch, feel free to contact me.<br/><br/><strong style="font-size:smaller">E-mail: </strong><a href="mailto:okimas.br@gmail.com" target="_blank">okimas.br@gmail.com</a><br/><strong style="font-size:smaller">Skype: </strong><a href="https://join.skype.com/invite/o8wMlbaSiIuv" target="_blank">okimas_br</a>',
          },
        ],
      },
    ],
